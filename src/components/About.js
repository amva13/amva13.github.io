        ...
        <div className="roww">
          ...
          <div className="resumo_fn_main_title">
            ...
            <p className="desc">
              ...
              <p className="desc">
              {`His professional life has been marked by a passion for computer science. As a young student, he was amazed by the sheer power of the field's problem-solving philosophy and the degree of impact one could have in so many fields, being amazed by the computational modeling of human cognition he learned about through my coursework and my ability to have impact across gerrymandering cases all over the nation through code I developed during research at MIT’s Computer Science and Artificial Intelligence Laboratory. The latter experience was his first practical exposure to high performance scientific computing. The ability to use different aspects of computation, from geometric algorithm optimization to distributed systems for data processing and Python/C++ programming considerations to advance the practice of science on a high impact problem in social justice was exciting to his and researching and leveraging applied mathematical techniques for modeling political redistricting systems allowed him to take on challenges in political science in a way better suiting his interests. He would carry this interest in high performance scientific computation further in his career.`}
              </p>
              <p className="desc">
