      ...
      <div className="container">
        <div className="roww">
          ...
          <div className="resumo_fn_main_title">
            ...
            <p className="desc">
    {'My research at HMS lies at the intersection of single-cell biology, foundation models and LLMs, and DrugAI. I\'ve led the development of the Therapeutic Commons (tdcommons.ai), focusing on single-cell foundation models and contextual AI.'}
            </p>
            {/* <p className="desc">
